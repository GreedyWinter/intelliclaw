...
def get_agent_manifest() -> dict[str, object]:
    ...
    return {
        ...
        "adk_ready_notes": [
            ...
            "Each PDF now produces one reconstructed canonical extraction CSV per attempt for evaluator review.",
            "Sentence rewriting, reconstruction, grammar evaluation, aggregate evaluation, and gap summarization can call Gemini when GOOGLE_API_KEY is configured.",
